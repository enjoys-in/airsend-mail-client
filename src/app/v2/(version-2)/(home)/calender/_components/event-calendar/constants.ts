...
// Start and end hours for the week and day views (full 24h)
export const StartHour = 0; // 12 AM
export const EndHour = 24; // 12 AM next day

// Default start and end times for new event creation
export const DefaultStartHour = 9; // 9 AM
export const DefaultEndHour = 10; // 10 AM

// Hour to auto-scroll to on initial load (scroll to business hours)
export const ScrollToHour = 7;
