    ...
    <Sidebar collapsible="none" className="hidden flex-1 md:flex ">
      ...
      <div className="flex flex-row items-center  w-full p-2">
        <Link prefetch href="/v2/u/compose"
          className="flex items-center gap-2 px-3 py-2 rounded-md bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-400 cursor-pointer transition"
        >
