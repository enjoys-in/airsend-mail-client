        ...
        <div className="relative z-10">
          <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
            <h1 className="font-semibold dark:text-neutral-100 text-neutral-900 text-5xl md:text-6xl">
              <span className="text-[#ff0] ">Privacy Policy:</span> Airsend
            </h1>
            <div className="max-w-4xl">
              <p className="mt-5 text-neutral-600  text-lg">
                Welcome to Airsend. This privacy policy explains how we collect, use, and protect your data when using our services.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className=" flex flex-col items-center py-10 px-4 md:px-20 bg-neutral-200 dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
        <div className="w-full max-w-3xl p-6 ">
          <div className="  w-full  p-2">
            ...
            <p>
              Airsend provides both temporary email services and custom domain email solutions. Our services enable users to manage emails securely and efficiently.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">2. Data Collection & Usage</h2>
            <p>
              - We collect minimal personal data required for authentication and service functionality.
              <br />- Cookies are used to enhance user experience and maintain sessions.
              <br />- Temporary emails are automatically deleted after a set period.
              <br />- Some analytics may be used to improve our service.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">3. Cookies & Tracking</h2>
            <p>
              We use cookies to enhance your browsing experience. You can disable cookies in your browser settings, but some functionalities may be affected.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">4. Security & Encryption</h2>
            <p>
              Airsend prioritizes security with encrypted email storage (for custom domains) and automatic deletion policies for temporary emails.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">5. Third-Party Services</h2>
            <p>
              We do not share user data with third-party advertisers. However, we may use third-party analytics for improving our service.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">6. User Rights & Contact</h2>
            <p>
              Users can request data deletion and access to stored information at any time. For inquiries, contact su@enjoys.in
            </p>
          </div>
        </div>
      </div>
