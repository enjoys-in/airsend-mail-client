...
export default function TermsAndConditions() {
  ...
  return (
    <>
      <div className="relative overflow-hidden pt-4 bg-neutral-200 dark:bg-neutral-900">
        ...
        <div className="relative z-10">
          <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
            <h1 className="font-semibold dark:text-neutral-100 text-neutral-900 text-5xl md:text-6xl">
              <span className="text-[#ff0] ">Terms & Conditions:</span> Airsend
            </h1>
            <div className="max-w-4xl">
              <p className="mt-5 text-neutral-600  text-lg">
                Welcome to Airsend. Please read these terms and conditions carefully before using our services.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className=" flex flex-col items-center py-10 px-4 md:px-20 bg-neutral-200 dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
        <div className="w-full max-w-3xl p-6 ">
          ...
          <div className=" w-full   p-2">
            ...
            <p>
              By accessing or using Airsend, you agree to abide by these Terms and Conditions. If you do not agree, please refrain from using our services.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">2. Use of Services</h2>
            <p>
              Airsend offers temporary email services and custom domain mail solutions. Temporary email accounts are automatically deleted after a set period. Custom domain email services require authentication and adherence to service guidelines.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">3. Account Responsibilities</h2>
            <p>
              If you register for a Airsend account, you are responsible for maintaining the confidentiality of your credentials and for any activity that occurs under your account.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">4. Prohibited Activities</h2>
            <p>
              - Using Airsend for spam, phishing, or illegal activities.
              <br />- Attempting to bypass security features or access unauthorized data.
              <br />- Disrupting the service or engaging in harmful activities.
              <br /><strong>Note:</strong> Spamming, bulk mailing, mass mailing, phishing, or any unauthorized email activity is strictly prohibited. Violations may result in account suspension, IP bans, or permanent restrictions.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">5. Privacy & Data Handling</h2>
            <p>
              Airsend respects your privacy. We collect minimal data necessary for service functionality and use cookies for session management. Temporary emails are automatically deleted, and we do not share user data with third parties.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">6. Termination of Service</h2>
            <p>
            ...
            <p>
              Airsend is provided "as is" without any warranties. We are not liable for data loss, service interruptions, or damages arising from the use of our service.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-2">8. Changes to Terms</h2>
            <p>
              We may update these terms at any time. Continued use of Airsend after changes indicates acceptance of the revised terms.
            </p>
          </div>
        </div>
      </div>
