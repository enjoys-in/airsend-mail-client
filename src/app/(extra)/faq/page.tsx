                ...
                <div className="max-w-2xl mx-auto divide-y divide-gray-200 dark:divide-neutral-700">
                    ...
                    <div className="py-8 first:pt-0 last:pb-0">
                        <div className="flex gap-x-5">
                            ...
                            <div className="grow">
                                <h3 className="md:text-lg font-semibold text-gray-800 dark:text-neutral-200">
                                    How does Airsend's pricing work?
                                </h3>
                                <p className="mt-1 text-gray-500 dark:text-neutral-500">
                    ...
                    <div className="py-8 first:pt-0 last:pb-0">
                        <div className="flex gap-x-5">
                            ...
                            <div className="grow">
                                <h3 className="md:text-lg font-semibold text-gray-800 dark:text-neutral-200">
                                    How secure is Airsend?
                                </h3>
                                <p className="mt-1 text-gray-500 dark:text-neutral-500">
                                    Protecting the data you trust to Airsend is our first priority. This part is really crucial in keeping the project in line to completion.
                                </p>
                            </div>
                        </div>
                    </div>
